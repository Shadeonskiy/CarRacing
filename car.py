...
RED_CAR = scale_image(pygame.image.load("images/Cars/Red Car/carRed_0.png"),
                      0.55)
GREEN_CAR = scale_image(pygame.image.load("images/Cars/Green Car/carGreen_0.png"),
                        0.55)
...
class Car:
    ...
    def move_forward(self):
        """
        Changes car velocity when it's moves forward and then
    ...
    def collide(self, mask, x=0, y=0):
        """
        Returns point of intersection between two objects.
        None if POI doesn't exist
        """
...
class ComputerCar(Car):
    ...
    def __init__(self, max_vel, rotation_vel, car_sprites,
                 path=[], track_index=1, finish_index=0):
    ...
    def move(self):
        ...
        """
        # check this to ensure that we won't get an index error
        # when trying to move towards the point that doesn't exist
    ...
    def update_path_point(self):
        """
        Sets the next waypoint when the computer car crosses
        previous point from the path
        """
